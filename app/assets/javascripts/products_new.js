      ...
      reader.onload = (function(file){
        return function(e){
          ...
          if (imageLength < 9) {
            ...
            $("#image-input").append(`<label for="product_images${labelLength+1}" class="sell-container__content__upload__items__box__label" data-label-id="${labelLength+1}">
                                        <input multiple="multiple" class="sell-container__content__upload__items__box__input" id="product_images${labelLength+1}" style="display: none;" type="file" name="product[images][]">
      ...
      if (parentCategoryId == ''){
        ...
        .done(function(category_children){
          ...
          $('#error-category').before(`<div class="sell-collection_select " id="select-children-box">
                                          <label class="sell-collection_select__label" for="product_category_id">
                                            <select class="sell-collection_select__input" id="category-select-children" required="required" name="product[category_id]">
      ...
      if (childrenCategoryId == ''){
        ...
        .done(function(category_grandchildren){
          ...
          $('#error-category').before(`<div class="sell-collection_select " id="select-grandchildren-box">
                                          <label class="sell-collection_select__label" for="product_category_id">
                                            <select class="sell-collection_select__input" id="category-select-grandchildren" required="required" name="product[category_id]">
                                              <option value="">選択して下さい</option>
                                              ${optionHtml}
                                            </select>
                                            <i class="fas fa-chevron-down"></i>
  ...
  $(function(){
    ...
    $('.sell-container__content__price__form__box').on('blur',function(){
      ...
      if(value < 1 || value > 9999999){
        $('#error-price').text('1以上9999999以下で入力してください');
        $(this).css('border-color','red');
      }else{
        $('#error-price').text('');
        $(this).css('border-color','rgb(204, 204, 204)');
